...
def create_data_loaders(data, batch_size):
    ...
    train_data_path = os.path.join(data, 'train_data') # Calling OS Environment variable and split it into 3 sets
...
if __name__=='__main__':
    ...
    parser.add_argument(
        "--epochs", type = int, default = 25, metavar = "E", help = "epochs (default: 5)"
    )
